...
> **兼容性：** Godot **4.7+** ｜ 类型：编辑器插件 ｜ 版本：1.0.0 ｜ 作者：Zzzl_io ｜ 许可：MIT
>
...
| 官方中文描述 | 简要简介 + 完整说明，保留官方超链接，一键跳转文档 |
...
**官方描述：** 每个节点的说明文字直接取自 Godot 官方文档，保留英文类名与文档超链接，悬停即可查看，点击直达官方文档。
